...
const CATEGORIES = ["All", "Textbooks", "Electronics", "Furniture", "Clothing", "Utensils", "Stationery", "Bedding", "Services"];
    ...
    <div className="container py-10 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        <div className="flex flex-col gap-2">
          <h1 className="text-4xl font-bold tracking-tight">Marketplace <span className="text-primary">Feed</span></h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium">Browse items listed by your fellow students.</p>
        </div>
            ...
            <div className="flex flex-col gap-1">
              {CATEGORIES.map(cat => (
                <button
                  ...
                  className={`flex items-center justify-between px-4 py-2.5 rounded-lg text-sm font-bold transition-all ${selectedCategory === cat
            ...
            <div className="flex flex-wrap gap-2">
              {["All", "New", "Like New", "Excellent", "Used"].map(cond => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all border ${selectedCondition === cond
